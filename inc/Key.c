...
void Key_Init(void){
    uint32_t temp = 0;
    IOMUX->SECCFG.PINCM[PB16INDEX] = (uint32_t) 0x00050081;
    IOMUX->SECCFG.PINCM[PB17INDEX] = (uint32_t) 0x00050081;
    IOMUX->SECCFG.PINCM[PB18INDEX] = (uint32_t) 0x00050081;
    IOMUX->SECCFG.PINCM[PB19INDEX] = (uint32_t) 0x00050081;
    temp |= (1<<16) | (1<<17) | (1<<18) | (1<<19);
    temp = ~temp;
    GPIOB->DOE31_0 &= temp;
}
