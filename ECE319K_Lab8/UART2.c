...
void UART2_Init(void){
  ...
  // baud = 2000 bps
  // divisor = 2,500,000 / (16*2000) = 78.125
  UART2->IBRD = 1250;
  UART2->FBRD = 0;

  UART2->LCRH = 0x00000030;

  // interrupt only on receive timeout RTOUT
  UART2->CPU_INT.IMASK = 0x0001;

  // keep IFLS as specified by lab
  UART2->IFLS = 0x0422;
  ...
  // IRQ 14 priority is bits 23-22 in NVIC->IP[3]
